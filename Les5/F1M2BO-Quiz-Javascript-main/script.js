...
function finishQuiz() {
  ...
  {
    resultBox.innerHTML += "<p>Je hebt alle antwoorden goed. Je hebt een prijs gewonnen.</p>";
  }
  else
  {
    resultBox.innerHTML += "<p>Helaas. Je hebt niet alle antwoorden goed. Je hebt geen prijs gewonnen.</p>";
  }
}
